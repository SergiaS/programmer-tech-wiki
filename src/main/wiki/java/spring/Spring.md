...
### Реализации AppicationContext
<u>Чаще всего используются следующие реализации `AppicationContext:</u>
...
Проксирование чаще всего задается аннотациями: при поднятии приложения и создании контекста на основе пре-процессоров Spring анализирует аннотации бинов и, находя указание к проксированию, создает прокси (обертку) над исходным объектом. В контекст Spring попадает уже не исходный инстанс класса, а его прокси. 
...
A: Аттрибут класса модет быть пропущен; Бин не реализован в контейнере.
