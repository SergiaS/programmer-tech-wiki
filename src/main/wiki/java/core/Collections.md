...
Потому что хеш-код массива вычисляется при его создании и не зависит от кол-ва элемента в нем (метод вычисления хэш-кода массива не переопределен и вычисляется по стандартному `Object.hashCode` на основании адреса массива).
